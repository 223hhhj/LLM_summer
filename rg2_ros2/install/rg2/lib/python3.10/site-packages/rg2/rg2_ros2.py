...
class GripperNode (Node):
    def __init__ (self):
        ...
        self.rob = urx.Robot("192.168.1.3")
        self.gripper = OnRobotGripperRG2(self.rob)
        
        self.gripper.open_gripper(
        
        target_width=12,  # Width in mm, 100 is fully open
        target_force=30,  # Maximum force applied in N, 40 is maximum
        payload=5,  # Payload in kg, 5 is maximum
        set_payload=True,  # If any payload is attached
